...
<div id="telecharge-document">
    ...
    <div class="row">
        <div class="col-md-4">
            <button class="btn btn-primary btn-md" wire:click="stepperAction({{$media->id}},8)">Précédent</button>
        </div>
        @if($media->stape==9)
        <div class="col-md-4">
        ...
        <div class="col-md-4">
            <button class="btn btn-primary btn-md float-right" wire:click="stepperAction({{$media->id}},10)">Suivant</button>
        </div>
        @endif
    </div>
</div>
