<div class="modal fade" id="showModelAddFormeJuridique" tabindex="-1" aria-labelledby="showModelAddFormeJuridique" aria-hidden="true" wire:ignore.self>
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-light">
                <h5 class="modal-title"> Ajouter une Forme Juridique</h5>
