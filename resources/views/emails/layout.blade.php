                                                                ...
                                                                <tr>
                                                                    <td class="v-text-align"
                                                                        ...
                                                                        <img align="center" border="0"
                                                                            src="http://localhost:9000/backend/assets/images/guinee.png"
                                                                        ...
                                                                        @else
                                                                        <img align="center" border="0"
                                                                            src="{{asset('backend/assets/images/guinee.png')}}"
                                                                            alt="image" title="image"
                                                                            style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 91%;max-width: 163.8px;"
                                                                            width="163.8"
                                                                            class="v-src-width v-src-max-width" />
                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <h1 class="v-text-align v-line-height v-font-size"
                                                                ...
                                                                <strong>Ministère de l'information et de la
                                                                    communication</strong></h1>
                                                        ...
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div class="v-text-align v-line-height v-font-size"
                                                                ...
                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                                        style="font-family: 'Open Sans', sans-serif; font-size: 14px; line-height: 19.6px;">Direction
                                                                        Nationale de la Communication et des Relations
                                                                        avec les Médias Privés (DNCRMP)</span></p>
                                                            </div>
                                                        ...
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div class="v-text-align v-line-height v-font-size"
                                                                ...
                                                                <p style="font-size: 14px; line-height: 140%;">
                                                                    <span style="font-family: 'Open Sans', sans-serif; font-size: 14px; line-height: 19.6px;">+224 610 19-19-46| mic@mic.gov.gn</span></p>
                                                            </div>
                                                            ...
                                                            <table width="100%" cellpadding="0" cellspacing="0"
                                                                ...
                                                                <tr>
                                                                    <td class="v-text-align"
                                                                        ...
                                                                        @if(config("app.env")== 'local')
                                                                        <img align="center" border="0"
                                                                            src="http://localhost:9000/assets/dist/img/branding-logo.png"
                                                                            alt="image" title="image"
                                                                            style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 91%;max-width: 163.8px;"
                                                                            width="163.8"
                                                                            class="v-src-width v-src-max-width" />
                                                                        @else
                                                                        <img align="center" border="0"
                                                                            src="{{asset('assets/dist/img/branding-logo.png')}}"
                                                                            alt="image" title="image"
                                                                            style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 91%;max-width: 163.8px;"
                                                                            width="163.8"
                                                                            class="v-src-width v-src-max-width" />
                                        ...
                                        <div
                                            ...
                                            <table style="font-family:'Open Sans',sans-serif;" role="presentation"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            style="overflow-wrap:break-word;word-break:break-word;padding:0px 0px 10px;font-family:'Open Sans',sans-serif;"
                                                            align="left">
                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div class="v-text-align v-line-height v-font-size"
                                                                ...
                                                                <p style="line-height: 140%;">Copyright &copy; {{
                                                                    date('Y') }}, Tout droit réservé</p>
                                                            </div>
